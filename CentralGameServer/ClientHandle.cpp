...
//	auto func = callRedirectFunction(51);
//
//	this->stopRequest = true; // doesnt do anything for now
//
//	this->valid = false;
//
//	this->recieveHandle.messages.clear();
//	this->recieveHandle.mmap.clear();
//
//	this->sendHandle.messages.clear();
//	this->sendHandle.mmap.clear();
//
//	this->sendHandle.cMessage.clear();
//
//	
//	
//}
...
//}
//
//std::shared_ptr<std::shared_ptr<shared_redirect_memory>> ClientHandle::_getRedirectMemory(uint32_t redirect_func_id)
//{
//	if (!redirectMap.contains(redirect_func_id))
//	{
//		std::cout << "Not found\n";
...
//}
//
//std::function<void(ClientHandle*,std::shared_ptr<R_Message>)> ClientHandle::callRedirectFunction(uint32_t redirect_func_id)
//{
//	if (!redirectMap.contains(redirect_func_id))
//	{
//		return [](ClientHandle*, std::shared_ptr<R_Message>) {return; };
//	}
//	return redirectMap.at(redirect_func_id).function;
//	//my man
//}
//
...
//{
//	//unused due to forward declaration with server
...
//		{
//			std::bind(redirectFunc->second.function, this, message);
